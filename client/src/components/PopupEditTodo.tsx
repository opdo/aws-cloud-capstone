...
> {
    ...
    handleSubmit = async (event: React.SyntheticEvent) => {
        ...
        try {
            ...
            const uploadUrl: string = await patchTodo(this.props.auth.getIdToken(), this.props.item.todoId, updateModel)
                ...
                <Modal.Content image>
                    ...
                    <Modal.Description>
                        <Form onSubmit={this.handleSubmit}>
                            <Form.Field>
                                <label>Task</label>
                                <input placeholder='Task' value={this.state.name}
                            ...
                            <Form.Field>
                                <Checkbox label='Mark done'
                                    ...
                                    onChange={(e, data) => this.setTodoDone(data.checked === true)} />
                            </Form.Field>
    ...
    renderButton() {
        ...
        return (
            <div>
                {this.state.uploadState === UploadState.SavingData && <p>Saving data</p>}
